            ...
            <div class="card vh-100">
                <div class="card-body">
                    <form action="{{ route('profile.update', auth()->id()) }}" method="POST"
                        class="col-md-4 mx-auto bg-white p-5 rounded" id="profile_form">
                        @csrf @method('PUT')
                        ...
                        <button type="button" class="btn btn-primary form-control"
                            onclick="event.preventDefault();confirm('Do you want to update?', '', 'update').then(res => res.isConfirmed ? $('#profile_form').submit() : false)">Submit
