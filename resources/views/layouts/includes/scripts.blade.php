<script src="{{ asset('assets/js/core/popper.min.js') }}"></script> {{--BS Jquery--}}
<script src="{{ asset('assets/js/core/bootstrap.min.js') }}"></script> 
<script src="{{ asset('assets/js/material-dashboard.js?v=3.0.0') }}"></script> {{--Material DB CSS--}}
...
<script src="{{ asset('js/shared/utils.js') }}"></script> {{--Utils--}}
<script src="{{ asset('js/shared/crud.js') }}"></script>