...
<link type="text/css" href="{{ asset('assets/css/utils/mainfont.css') }}" rel="stylesheet" /> {{-- Fonts --}}
<link href="{{asset('assets/css/nucleo-icons.css')}}" rel="stylesheet" />
<link href="{{ asset('assets/css/nucleo-svg.css') }}" rel="stylesheet" />
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('img/favicon/apple-touch-icon.png') }}"> {{-- Favicon --}}
...
<link id="pagestyle"  href="{{ asset('assets/css/material-dashboard.css?v=3.0.0') }}" rel="stylesheet" /> {{-- Css Files --}}
...
<link href="{{ asset('assets/css/utils/datatables.bootstrap5.min.css') }}" rel="stylesheet" /> {{-- DataTables --}}
