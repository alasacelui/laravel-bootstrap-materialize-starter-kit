...
<script src="{{ asset('assets/js/bootstrap/bootstrap.min.js') }}"></script> {{-- BS Jquery --}}
<script src="{{ asset('assets/js/core/material-dashboard.js?v=3.0.0') }}"></script> {{-- Materialize Js --}}
<script src="{{ asset('assets/js/core/app.js') }}"></script> {{-- App Js --}}
...
<script src="{{ asset('assets/js/utils/print.min.js') }}"></script> {{-- App Js --}}
...
<script src="{{ asset('assets/js/utils/filepond-plugin-file-validate-type.js') }}"></script> {{-- FP --}}
